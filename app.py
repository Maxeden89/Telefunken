...
async def main(page: ft.Page):
    ...
    btn_cancelar = ft.FilledButton("Cancelar", icon=ft.icons.RESTART_ALT, on_click=cancelar_todo)
    btn_bajar = ft.FilledButton("Bajar Juego", on_click=realizar_bajar_juego)
    btn_tirar = ft.FilledButton("Descartar", on_click=realizar_descarte)
